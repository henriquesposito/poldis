...
commitment[which(commitment$word=="obligatory"),3] <- commitment[which(commitment$word=="oblige"),3]
#commitment[which(commitment$word=="require"),3] <- commitment[which(commitment$word=="need to"),3]
...
#commitment[which(commitment$word=="urge"),3] <- commitment[which(commitment$word=="going to"),3]
...
commitment[which(commitment$word=="option"),3] <- commitment[which(commitment$word=="optional"),3]
