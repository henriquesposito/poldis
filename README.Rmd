...
`{poldis}` contains the tools required for wrangling and annotating
...
Although the functions developed in the package consider the theoretical implications of working with political texts, they prioritize flexibility and accessibility. This means users can select promises, gather topics, and/or measure urgency for various other types of texts.
