...
For now this is a private project, but soon it is set to become
a source of publicly available data on political discourses while
offering several functions for text analysis.
