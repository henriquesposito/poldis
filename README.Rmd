...
UA rests upon a multidimensional and survey-validated conception of how urgency can be expressed in political discourses. It combines Natural Language Processes (NLP) and dictionary approaches to provide a contextualized and interpretable new method for the analysis of political texts.
...
```{r context}
extract_context(" war ", US_inaugural_addresses_1993_2025$text,
                level = "sentences", n = 1)
```
...
Using four purpose-built dictionaries of terms, we code different aspects of urgency in political discourses:
...
```{r urgency}
get_urgency(US_inaugural_addresses_1993_2025$text, summarise = "mean")
```
