...
This branch contains *only* the raw data used in the package and/or analysis. Please refer to the [master branch](https://github.com/henriquesposito/poldis) for the latest release and to the [develop branch](https://github.com/henriquesposito/poldis/tree/develop) for the exciting, things happening but not yet ready to be released.

# Citation

If you are using ´{poldis}´ (or the data), please do not forget to cite us ;)
