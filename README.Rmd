...
Political discourses are fundamentally different from other types of discourses
as they are usually unstructured and may cover multiple topics each time.
Political discourse as data may also come in many different forms,
...
making it easier to work with political discourses.
...
UA rests upon a multidimensional, weighted, and survey-validated conception of how urgency can be expressed in political discourses. It combines Natural Language Processes (NLP) and dictionary approaches to provide a contextualized, comparable, and scaleable new method for the analysis of political texts.
